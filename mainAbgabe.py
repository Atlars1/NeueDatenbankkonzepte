...
class GraphInterface:
    ...
    def interface_logic(self):
        ...
        while True:
            ...
            if transport_choice in ['1', '2', '3', '4']:
        ...
        while True:
            try:
                print("Do you want to avoid any countries? (1:Germany 2:Austria 3:Italy, enter -1 to skip): ")
                node_type_to_avoid = int(input())
                if node_type_to_avoid in [-1, 1, 2, 3]:
                    if node_type_to_avoid != -1:
                        self.temporarily_avoid_node_type(node_type_to_avoid)
                    break
                else:
                    print("Invalid input. Please enter -1, 1, 2, or 3.")
        ...
        while True:
            try:
                ...
                # Überprüfen Sie, ob die Knotennummern gültig sind.
                if -1 < start_node <= max_nodes and -1 < end_node <= max_nodes and start_node != end_node:
                    break  # Beendet die Schleife, wenn die Eingaben gültig sind.
                else:
                    print("Invalid input. Try again!")
            
            except ValueError:  # Wird ausgelöst, wenn die Eingabe keine ganze Zahl ist.
        ...
        while True:
            try:
                ...
                if avoid_node == -1 or (0 < avoid_node <= max_nodes and avoid_node != end_node and avoid_node != start_node):
                    break  # Gültige Eingabe, beendet die Schleife
                else:
        ...
        while True:
            strategy_choice = input("Please choose your pathfinding strategy by number (1-2): ")
