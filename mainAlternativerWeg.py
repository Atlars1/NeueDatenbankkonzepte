...
class GraphInterface:
    ...
    def interface_logic(self):
        ...
        # Option zum Anzeigen alternativer Wege
        print("Would you like to display alternative paths? (y/n)")
        show_alternatives = input().lower() == 'y'
        if show_alternatives:
            alternative_paths = self.find_alternative_paths(path)
            for i, alt_path in enumerate(alternative_paths):
                print(f"Alternative path {i + 1}: {alt_path}")
    ...
    def find_alternative_paths(self, original_path):
        ...
        for i in range(len(original_path) - 1):
            ...
            # Temporär das Gewicht der Kante erhöhen
            ...
            try:
                ...
                pass  # Kein alternativer Weg gefunden
    ...
    def main(self):
        self.create_and_store_graph(10)  # Beispiel: Erstellen eines Graphen mit 10 Knoten
